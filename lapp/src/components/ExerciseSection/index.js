const ExerciseSection = ({ exercise }) => {
  ...
  return (
    <div>
      <div class="flex flex-row border-4 border-[#5C0120] rounded-2xl text-[#1B1C1E] not-italic items-center justify-between px-9 py-3 mt-4 w-full  hover:bg-[#B02B3B] hover:text-[#F1E0CE]">
